package com.tcs.assurance.prueba.utils.readers;
...
import static com.tcs.assurance.prueba.models.enums.ManagementCSV.FILTRO;
...
public class PropsCsv {
    ...
    public static List<Map<String, String>> getDataCsv(String nombreCSV, String filtro) throws IOException {
        TestDataSource testData = new CSVTestDataSource("src/main/resources/DataDriven/" + nombreCSV + ".csv", ';');
